...
export function ActiveOrdersIcon({ className = base }: IconProps) {
  return (
...
export function CommunicationIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} className={className}>
      <path
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} className={className}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M3 8.5 12 13l9-4.5M12 13v7" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
